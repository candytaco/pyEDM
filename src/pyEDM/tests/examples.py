...
def main():
    ...
    df = EDM.FindOptimalPredictionHorizon(dataFrame = EDM.sampleData["TentMap"],
                                          columns = "TentMap", target = "TentMap",
                                          train = [1, 100], test = [201, 500], maxTp = 10,
                                          E = 2, step = -1, exclusionRadius = 0,
                                          validLib = [], numProcess = 4);

    df = EDM.FindSMapNeighborhood(dataFrame = EDM.sampleData["TentMapNoise"],
                                  columns = "TentMap", target = "TentMap",
    ...
    S = EDM.FitSimplex(dataFrame = EDM.sampleData["block_3sp"],
    ...
    M = EDM.FitMultiview(dataFrame = EDM.sampleData["block_3sp"],
                         columns = ["x_t", "y_t", "z_t"], target = "x_t",
    ...
    S = EDM.FitSMap(dataFrame = EDM.sampleData["circle"],
    ...
    CM = EDM.FitCCM(dataFrame = EDM.sampleData["sardine_anchovy_sst"],
